...
import { updateLocaleSchema, updateProfileSchema } from "./users.schema";
...
usersRouter.put("/me", requireAuth, validate(updateProfileSchema), asyncHandler(usersController.updateMe));

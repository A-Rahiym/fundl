...
export function Footer() {
  ...
  return (
    <footer className="px-4 pt-20 tablet:px-8">
      <div className="mx-auto w-full max-w-[1280px] overflow-hidden rounded-2xl border-t-8 border-red bg-ink text-white shadow-standard">
          ...
          <div>
            ...
            <form className="flex" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="w-full min-w-0 rounded-l-[6px] border-2 border-r-0 border-red bg-white px-3 py-2.5 text-sm text-ink placeholder:text-ink/40 focus:outline-none"
              />
              <button
                type="submit"
                aria-label={t('footer.subscribe')}
                className="flex shrink-0 items-center justify-center rounded-r-[6px] border-2 border-red bg-red px-3 text-white transition-colors hover:bg-red-dark"
              >
